...
### Macroinv_2022_stats: 
Statistical analyses for biodiversity data.
...
### Macroinv_2022_stats_alt_models: 
All alternative tested models.
  
### GHG_rates_2022: 
Calculating original CH<sub>4</sub> emission rates from sampled GHG concentration through gas chromatography.
...
### GHG_rates_2022_w_corrections: 
Applying corrections to GHG (CH<sub>4</sub>, N<sub>2</sub>O and CO<sub>2</sub>) emission rates.   
...
### Emissions_2022: 
Working with GHG emission rates data.
...
### Emissions_2022_stats: 
Statistical analyses for GHG emission rates data.
